...
SECRET_KEY = "django-insecure-uu5(uy7sg18er_j3%m4$!a10b3p9d0acn0kw4w70pvm#p3s7h_"
...
INSTALLED_APPS += ["accounts", "cafe", "menu", "location"]
...
GRAPHQL_JWT = {
    ...
    "JWT_ALLOW_ANY_HANDLER": "core.utils.allow_any",
